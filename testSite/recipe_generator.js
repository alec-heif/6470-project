...
fontA = createFont("Century Gothic",17);
textFont(fontA, 17);
  size(1000,50);
  fill(0);
  ingredient = loadStrings("./resources/");
  technique = loadStrings("http://www.cutsquash.com/processing/recipe_generator/recipeGenerator2/data/technique.txt");
  adjective = loadStrings("http://www.cutsquash.com/processing/recipe_generator/recipeGenerator2/data/adjective.txt");
  linker = loadStrings("http://www.cutsquash.com/processing/recipe_generator/recipeGenerator2/data/linker.txt");
  product = loadStrings("http://www.cutsquash.com/processing/recipe_generator/recipeGenerator2/data/product.txt");
  T = new boolean[6][6];
